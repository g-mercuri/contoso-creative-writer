...
def evaluate_image(project_scope, image_path):
    ...
    if results_df.empty:
        ...
        protected_materials_evals = results_df[['protected_material.fictional_characters_defect_rate', 'protected_material.logos_and_brands_defect_rate', 'protected_material.artwork_defect_rate']]
